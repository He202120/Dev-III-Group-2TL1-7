        ...
        <div className="flex flex-col">
          <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6">
            <div className="grid gap-4 md:grid-cols-2">
              <StatCard title="Nombre de minutes jouées" value={userData?.minutesPlayed || '0'} />
              <StatCard title="Nombre de buts" value={userData?.goals || '0'} />
              <StatCard title="Nombre de cartons jaunes" value={userData?.yellowCards || '0'} />
              <StatCard title="Nombre de cartons rouges" value={userData?.red || '0'} />
            </div>
            <div>
              <Card>
                <Table>
